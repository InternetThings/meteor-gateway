...
* * Next you need to install node, npm and mongodb. This is done via this [script](https://bitbucket.org/dt_eaaa_h2_2015/meteor-gateway/raw/master/scripts/meteor_run.sh)
